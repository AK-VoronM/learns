...
<button href="/learns/?ctrl=Lessons&act=ShowLesson&id=<?php echo $this->lesson_prew->lesson_id; ?>"><?php echo $this->lesson_prew->lesson_name; ?></button>
<?php endif; ?>
<?php if($this->lesson_next): ?>
<button href="/learns/?ctrl=Lessons&act=ShowLesson&id=<?php echo $this->lesson_next->lesson_id; ?>"><?php echo $this->lesson_next->lesson_name; ?> </button>
<?php endif; ?>